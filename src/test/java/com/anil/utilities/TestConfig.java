...
public class TestConfig{
	...
	public static String from = "anil.shil2010@gmail.com";
	public static String password = "anil1234567890";
	public static String[] to ={"anil.shil2010@gmail.com","anild.kumarm@gmail.com"};
